...
public class Triangle extends HealthBar {
	public static final String NAME = "T";
	public static final String GRAPHICS = "T";
	public static final int STARTING_HEALTH = 150;
	public static final int TRIANGLE_MAX_HEALTH = 150;
	
	private int spindegree;
	
	public Triangle (Game game, int x, int y, double spindegree) {
		super(game, Triangle.NAME, true, x, y, CollisionIds.TRIANGLE, Triangle.GRAPHICS, STARTING_HEALTH, TRIANGLE_MAX_HEALTH);
		xdir = 1;
		ydir = 1;
		xspeed = 0;
		yspeed = 0;
